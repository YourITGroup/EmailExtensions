...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "Refactored.Email Class Library" /productName "Refactored.Email Class Library" > NUL
...
COPY /Y "Refactored.Email.msha" HelpContentSetup.msha
